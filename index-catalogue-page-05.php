...
<body class="animated slideInRight">
   <?php include("inc_header.php"); ?>
    ...
    <section class="container">
        ...
        <div class="artpiece col-4"><img src="./images/kimono-tsunami/2.jpg"></div>
